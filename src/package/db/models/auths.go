...
type Auth struct {
	...
	ProviderId null.String `boil:"providerId" json:"providerId,omitempty" toml:"providerId" yaml:"providerId,omitempty"`
...
var AuthTableColumns = struct {
	...
	ProviderId: "auths.providerId",
	Provider:   "auths.provider",
...
var AuthWhere = struct {
	...
	Password:   whereHelpernull_String{field: "\"auths\".\"password\""},
	ProviderId: whereHelpernull_String{field: "\"auths\".\"providerId\""},
	Provider:   whereHelperstring{field: "\"auths\".\"provider\""},
...
var (
	authAllColumns            = []string{"id", "password", "providerId", "provider", "id_user", "created_at"}
	authColumnsWithoutDefault = []string{"id_user"}
	authColumnsWithDefault    = []string{"id", "password", "providerId", "provider", "created_at"}
...
func (authL) LoadIDUserUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAuth interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.IDUserAuths = append(foreign.R.IDUserAuths, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.IDUser == foreign.ID {
				...
				foreign.R.IDUserAuths = append(foreign.R.IDUserAuths, local)
				break
			}
		}
	}
...
// Adds o to related.R.IDUserAuths.
func (o *Auth) SetIDUserUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	...
	if related.R == nil {
		related.R = &userR{
			IDUserAuths: AuthSlice{o},
		}
	} else {
		related.R.IDUserAuths = append(related.R.IDUserAuths, o)
	}
