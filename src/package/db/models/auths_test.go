...
var (
	authDBTypes = map[string]string{`ID`: `bigint`, `Password`: `text`, `ProviderId`: `text`, `Provider`: `text`, `IDUser`: `bigint`, `CreatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
